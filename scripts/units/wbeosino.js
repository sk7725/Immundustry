...
const redMissile = extend(MissileBulletType, {});
redMissile.speed = 2;
redMissile.height = 17;
redMissile.width = 8;
redMissile.shrinkY = 0.1;
...
redMissile.weaveScale = 1;
redMissile.lifetime = 60;
redMissile.despawnEffect = Fx.explosion;
redMissile.incendAmount = 10;
...
whirlWindMissileWeap.x = 5.2;
whirlWindMissileWeap.reload = 10;
whirlWindMissileWeap.inaccuracy = 1.1;
whirlWindMissileWeap.shots = 1;
whirlWindMissileWeap.shotDelay = 3;
whirlWindMissileWeap.bullet = whirlWindMissile;

const cytokine = new Weapon();
cytokine.rotate = true;
cytokine.x = 2.2;
cytokine.reload = 60;
cytokine.inaccuracy = 2.1;
cytokine.shots = 1;
cytokine.bullet = redMissile;
cytokine.shootStatus = StatusEffects.burning;
cytokine.shootStatusDuration = 550;
...
const whirlWind = extendContent(UnitType, "wbeosino", {});
...
whirlWind.weapons.add(cytokine);
whirlWind.health = 580;
